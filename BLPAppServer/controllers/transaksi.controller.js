...
export const newTransaksi = async (req, res, next) => {
    try {
...
export const getOneTransaksi = async (req, res, next) => {
    try {
...
export const updateTransaksi = async (req, res, next) => {
    try {
        ...
        if (!getTransaksi) return next(createError(404, "Transaksi not found!"))
        ...
        if (!updatedTransaksi) return next(createError(403, "Transaksi can not be updated!"))
